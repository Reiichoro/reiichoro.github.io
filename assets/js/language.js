const i18nData = {
    'zh': {
        ...
        // Tab 標題
        'tab-t1': '品質保障', 'tab-t2': '高效交付', 'tab-t3': '價格優勢', 'tab-t4': '技術專家',
        // Tab 1 (品質)
        't1-h': '零妥協的可靠系統',
        't1-p': '我們實施多層測試與代碼審查，確保您的軟體既穩健又安全。',
        't1-li1': '自動化 QA 測試', 't1-li2': '代碼安全審計',
        // Tab 2 (速度)
        't2-h': '敏捷開發，快速上線',
        't2-p': '我們的 CI/CD 流水線讓我們能以閃電般的速度交付更新與新功能。',
        't2-li1': '兩週迭代週期', 't2-li2': '每日雲端部署',
        // Tab 3 (價格)
        't3-h': '優化成本，提高回報',
        't3-p': '通過智能資源分配與雲端成本管理，為您的投資提供最大價值。',
        't3-li1': '透明的價格體系', 't3-li2': '雲端資源優化',
        // Tab 4 (專家)
        't4-h': '專家級工程師團隊',
        't4-p': '我們的資深開發者在全棧開發與 AI 領域擁有數十年的豐富經驗。',
        't4-li1': '資深架構師領軍', 't4-li2': '24/7 全天候技術支持',
        // ... 我們的服務 ...
        'ser-sub': '我們的服務',
        'ser-title': '高品質技術解決方案',
        ...
        'team-title': '我們的技術專家',
        // 成員 1
        'team-p1': '深耕分布式系統與雲端架構 15 載，擁有卓越的技術洞察力。',
        'team-n1': '莎拉 · 強森',
        'team-r1': '首席技術官 (CTO)',
        // 成員 2
        'team-p2': '專精於 AI 模型整合與高併發後端系統開發。',
        'team-n2': '艾瑪 · 蘇珊',
        'team-r2': '技術組長',
        // 成員 3
        'team-p3': '深諳用戶心理學，專注於現代化前端框架的實現與體驗優化。',
        'team-n3': '威廉 · 安德森',
        'team-r3': '高級軟體架構師',
        // 技術日誌區塊 (Blog Section)
        'blog-sub': '最新動態',
    ...
    'en': {
        ...
        'tab-t1': 'Guaranteed Quality', 'tab-t2': 'Get There Faster', 'tab-t3': 'Lowest Pricing', 'tab-t4': 'Tech Specialists',
        't1-h': 'Reliable Systems, Zero Compromise',
        't1-p': 'We implement multi-layer testing and code reviews to ensure robustness.',
        't1-li1': 'Automated QA Testing', 't1-li2': 'Code Security Audits',
        't2-h': 'Agile Development, Rapid Launch',
        't2-p': 'Our CI/CD pipelines allow us to deliver updates at lightning speed.',
        't2-li1': '2-Week Sprint Cycles', 't2-li2': 'Daily Cloud Deployment',
        't3-h': 'Optimized Costs for ROI',
        't3-p': 'Smart resource allocation to give you the best value for your investment.',
        't3-li1': 'Transparent Pricing', 't3-li2': 'Cloud Resource Tuning',
        't4-h': 'Expert Engineers at Your Service',
        't4-p': 'Our senior developers bring decades of experience in full-stack and AI.',
        't4-li1': 'Senior Architect Lead', 't4-li2': '24/7 Technical Support',
        ...
        'team-p1': 'Expert in distributed systems and cloud architecture with 15+ years experience.',
        'team-n1': 'Sarah Jhonson',
        'team-r1': 'Chief Technology Officer',
        'team-p2': 'Specializes in AI model integration and high-concurrency backend development.',
        'team-n2': 'Emma Susan',
        'team-r2': 'Technical Lead',
        'team-p3': 'Expert in UI/UX psychology and modern frontend framework implementation.',
        'team-n3': 'William Anderson',
        'team-r3': 'Senior Software Architect',
        // Blog Section
